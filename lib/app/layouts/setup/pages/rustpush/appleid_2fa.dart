...
class _AppleId2FAState extends State<AppleId2FA> with ThemeHelpers {
                            ...
                            Opacity(
                                ...
                                child: TextField(
                                  ...
                                  autofocus: controller
                                      .goingTo2fa, // if we're not going don't pop up the keyboard for a transitive state
                                  focusNode: focusNode,
                  ...
                  Focus(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        border:
                            resendFocusNode.hasFocus ? Border.all(color: focusOutlineColor(context), width: 2) : null,
                        borderRadius: BorderRadius.circular(20),
                      ),
                      child: TextButton(
                          onPressed: appleHelping
                              ? null
                              : () async {
                                  appleHelp();
                                },
                          child: Text(controller.isSms.value ? "Resend code" : "Resend to Phone #",
                              style: context.theme.textTheme.bodyLarge!.apply(
                                  fontSizeFactor: 1.1, color: appleHelping ? HexColor('777777') : HexColor('2772C3')))),
                    ),
                  ),
                  const SizedBox(height: 20),
                  Row(
