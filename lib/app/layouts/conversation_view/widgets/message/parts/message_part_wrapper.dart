...
class MessagePartWrapper extends StatelessWidget {
  ...
  void completeEdit(AttributedBody newEdit) async {
    cvController.editing.removeWhere((e2) => e2.message.guid == message.guid! && e2.part.part == part.part);
    final currentAttributed = AttributedBody(
      string: part.text ?? "",
      runs: part.annotations
          .map((a) => Run(
    ...
    if (newEdit.string.isNotEmpty && jsonEncode(newEdit.toMap()) != jsonEncode(currentAttributed.toMap())) {
...
class _MessageContentBubble extends StatelessWidget {
  ...
  final Function(AttributedBody) onCompleteEdit;
...
class _EditModeTextField extends StatelessWidget {
  ...
  final ConversationViewController cvController;
  final MessagePart part;
  final Function(AttributedBody) onComplete;
          ...
          child: Focus(
            ...
            onKeyEvent: (_, ev) {
              ...
              if (ev.logicalKey == LogicalKeyboardKey.enter && !HardwareKeyboard.instance.isShiftPressed) {
                onComplete(editStuff.controller.getFinalAnnotations());
            ...
            child: CallbackShortcuts(
              bindings: editStuff.controller.getShortcuts(),
              child: TextField(
                textCapitalization: TextCapitalization.sentences,
                autocorrect: true,
                controller: editStuff.controller,
                focusNode: editStuff.controller.focusNode,
                ...
                maxLines: 14,
                minLines: 1,
                contextMenuBuilder: editStuff.controller.getContextMenuBuilder(),
                      ...
                      return Padding(
                        ...
                        child: TextButton(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              shape:
                                  SettingsSvc.settings.skin.value == Skins.iOS ? BoxShape.circle : BoxShape.rectangle,
