  ...
  List<TextSpan> getProperties() {
    ...
    if (message.expressiveSendStyleId != null) {
      ...
      if (message.datePlayed == null && !(message.isFromMe ?? false)) {
        ...
        message.save();
        final needsAlignment = stringToMessageEffect[effect] == MessageEffect.spotlight ||
            stringToMessageEffect[effect] == MessageEffect.love ||
            stringToMessageEffect[effect] == MessageEffect.lasers;
