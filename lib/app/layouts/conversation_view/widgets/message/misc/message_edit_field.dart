...
class MessageEditField extends StatelessWidget {
  ...
  final int part;
  final MentionTextEditingController editController;
  final ConversationViewController cvController;
  final void Function(AttributedBody text, int part) onComplete;
  ...
  KeyEventResult _handleKeyEvent(KeyEvent ev, Message message) {
    ...
    if (ev.logicalKey == LogicalKeyboardKey.enter && !HardwareKeyboard.instance.isShiftPressed) {
      onComplete(editController.getFinalAnnotations(), part);
          ...
          child: Container(
            ...
            child: Focus(
              ...
              child: CallbackShortcuts(
                bindings: editController.getShortcuts(),
                child: TextField(
                  ...
                  maxLines: 14,
                  minLines: 1,
                  contextMenuBuilder: editController.getContextMenuBuilder(),
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      ...
                      onPressed: () => onComplete(editController.getFinalAnnotations(), part),
                    ),
                  ),
                  onSubmitted: (value) {
