                  ...
                  return SettingsSwitch(
                    ...
                    onChanged: (value) {
                      if (chatState != null) {
                        ...
                        ChatsSvc.setChatPinned(chat, !chat.isPinned!);
                      }
                    },
                    backgroundColor: tileColor,
                  );
                  ...
                  return SettingsSwitch(
                    ...
                    onChanged: (value) {
                      if (chatState != null) {
                        ...
                        ChatsSvc.setChatArchived(chat, value);
                      }
                    },
                    backgroundColor: tileColor,
                  );
                ...
                SettingsSwitch(
                  ...
                  onChanged: (value) {
                    if (value) {
                              ...
                              actions: <Widget>[
                                ...
                                TextButton(
                                  ...
                                  onPressed: () async {
                                    Navigator.of(context, rootNavigator: true).pop();
                                    chat.handles.first.setBlocked(true);
                                    await ChatsSvc.setChatArchived(chat, true);
                                    setState(() {});
                                  },
                                ),
                              ]);
                      ...
                      ChatsSvc.setChatArchived(chat, false);
                      setState(() {});
                    }
                  },
                  backgroundColor: tileColor,
