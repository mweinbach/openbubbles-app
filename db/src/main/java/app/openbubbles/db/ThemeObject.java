...
public class ThemeObject {
    ...
    @Unique
    public String name;
    public Boolean selectedLightTheme;
    public Boolean selectedDarkTheme;
    public Boolean gradientBg;
    public Boolean previousLightTheme;
    public Boolean previousDarkTheme;
    @Backlink(to = "themeObject")
    public final ToMany<ThemeEntry> themeEntries = new ToMany<>(this, ThemeObject_.themeEntries);
