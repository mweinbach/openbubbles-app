...
package com.bluebubbles.messaging.services.rustpush.eap_aka;

import static com.bluebubbles.messaging.services.rustpush.eap_aka.EapAkaChallenge.SUBTYPE_AKA_CHALLENGE;
import static com.bluebubbles.messaging.services.rustpush.eap_aka.EapAkaChallenge.TYPE_EAP_AKA;
...
public class EapAkaResponse {
    ...
    public static EapAkaResponse respondToEapAkaChallenge(
        ...
        if (response == null) {
            throw new RuntimeException("EAP-AKA response is null!");
        }
        ...
        if (securityContext.getRes() != null
            ...
            @SuppressLint("MissingPermission") // getSubscriberId also works with USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER, Android Studio just doesn't know.
            String eap = getImsiEap(
            ...
            if (mk == null || mk.getAut() == null) {
                throw new RuntimeException("Can't generate K_Aut!");
            }
